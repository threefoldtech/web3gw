// code taken from https://github.com/emersion/go-imap/blob/v2/cmd/imapmemserver/main.go
package main
...
func main() {
	flag.StringVar(&listen, "listen", "localhost:1143", "listening address")
