...
// Source: /home/chaddad/threefold/web3_proxy/web3gw/server/clients/tfgrid/tfgrid.go

// Package mock_tfgrid is a generated GoMock package.
package mocks
...
// FilterContracts mocks base method.
func (m *MockTFGridClient) FilterContracts(filter types.ContractFilter, pagination types.Limit) ([]types.Contract, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FilterContracts", filter, pagination)
...
// FilterContracts indicates an expected call of FilterContracts.
func (mr *MockTFGridClientMockRecorder) FilterContracts(filter, pagination interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FilterContracts", reflect.TypeOf((*MockTFGridClient)(nil).FilterContracts), filter, pagination)
}
...
// FilterTwins mocks base method.
func (m *MockTFGridClient) FilterTwins(filter types.TwinFilter, pagination types.Limit) ([]types.Twin, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FilterTwins", filter, pagination)
...
// FilterTwins indicates an expected call of FilterTwins.
func (mr *MockTFGridClientMockRecorder) FilterTwins(filter, pagination interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FilterTwins", reflect.TypeOf((*MockTFGridClient)(nil).FilterTwins), filter, pagination)
}

// GetCounters mocks base method.
func (m *MockTFGridClient) GetCounters(filter types.StatsFilter) (types.Counters, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCounters", filter)
...
func (mr *MockTFGridClientMockRecorder) GetCounters(filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCounters", reflect.TypeOf((*MockTFGridClient)(nil).GetCounters), filter)
}
