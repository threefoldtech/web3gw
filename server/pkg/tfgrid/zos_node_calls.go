...
func (c *Client) ZOSDeploymentGet(ctx context.Context, request ZOSNodeRequest) (gridtypes.Deployment, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSDeploymentDelete(ctx context.Context, request ZOSNodeRequest) error {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSDeploymentUpdate(ctx context.Context, request ZOSNodeRequest) error {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSDeploymentChanges(ctx context.Context, request ZOSNodeRequest) ([]gridtypes.Workload, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSStatisticsGet(ctx context.Context, request ZOSNodeRequest) (tfgrid.Statistics, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSNetworkListWGPorts(ctx context.Context, request ZOSNodeRequest) ([]uint16, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return nil, pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSNetworkInterfaces(ctx context.Context, request ZOSNodeRequest) (map[string][]net.IP, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return nil, pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSNetworkPublicConfigGet(ctx context.Context, request ZOSNodeRequest) (client.PublicConfig, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSSystemDMI(ctx context.Context, request ZOSNodeRequest) (dmi.DMI, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSSystemHypervisor(ctx context.Context, request ZOSNodeRequest) (string, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return "", pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSSystemVersion(ctx context.Context, request ZOSNodeRequest) (client.Version, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSStoragePools(ctx context.Context, request ZOSNodeRequest) ([]client.PoolMetrics, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return nil, pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSHasPublicIPv6(ctx context.Context, request ZOSNodeRequest) (bool, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
...
func (c *Client) ZOSNetworkListAllInterfaces(ctx context.Context, request ZOSNodeRequest) (map[string]client.Interface, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return nil, pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSNetworkSetPublicExitDevice(ctx context.Context, request ZOSNodeRequest) error {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
		return pkg.ErrClientNotConnected{}
	}
...
func (c *Client) ZOSNetworkGetPublicExitDevice(ctx context.Context, request ZOSNodeRequest) (client.ExitDevice, error) {
	state, ok := c.state.Get(state.IDFromContext(ctx))
	if !ok || state.cl == nil {
